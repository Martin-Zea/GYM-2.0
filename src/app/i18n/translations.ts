...
export interface Translations {
  ...
  rail_expand: string;
  rail_group_today: string;
  rail_group_tools: string;
  rail_group_filter_day: string;
  rail_group_my_routines: string;
  rail_group_sections: string;
  rail_group_summary: string;
  rail_all_days: string;
  rail_today_focus: string;
  rail_rest_day: string;
  rail_week_done: string;
  rail_streak: string;
  rail_ai_month: string;
  rail_export_now: string;
  ...
  coach_title: string;
  coach_delta_same: string;
  coach_cause_layoff: string;
  coach_cause_injury: string;
  coach_cause_hard_feel: string;
  coach_cause_max_increase: string;
  coach_context_layoff: string;
  coach_context_no_notes: string;
  coach_desk_proposal: string;
  coach_desk_eyebrow: string;
  coach_col_exercise: string;
  coach_col_last: string;
  coach_col_proposal: string;
  coach_col_why: string;
  coach_desk_context: string;
  coach_desk_fix: string;
  coach_desk_changes: string;
  coach_desk_note: string;
  coach_desk_apply: string;
  coach_desk_first_time: string;
  coach_chat_side_title: string;
  coach_chat_side_sub: string;
