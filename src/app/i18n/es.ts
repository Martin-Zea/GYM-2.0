...
export const es: Translations = {
  ...
  routine_default_name: 'Mi rutina',
  routine_new: 'Nueva',
  routine_new_prompt: 'Nombre de la rutina nueva',
  routine_duplicate: 'Duplicar',
  routine_duplicate_prompt: 'Nombre de la copia',
  routine_copy_name: '{name} (copia)',
  routine_rename: 'Renombrar',
  routine_rename_prompt: 'Nuevo nombre',
  routine_delete: 'Borrar',
  routine_delete_confirm:
    '¿Borrar la rutina "{name}" y sus días? El historial de esas sesiones se conserva.',
  routine_delete_last: 'No podés borrar tu única rutina.',
  routine_from_template: 'Desde plantilla',
  routine_generate: 'Generar con IA',
  gen_days_label: 'Días por semana',
  gen_notes_label: 'Algo que deba tener en cuenta',
  gen_notes_placeholder: 'Ej.: molestia en el hombro, poco tiempo los martes…',
  gen_cost_estimate: 'Coste estimado: ~{total} tokens ({input} de entrada).',
  gen_run: 'Generar',
  gen_loading: 'Generando…',
  gen_review_title: 'Revisá antes de guardar',
  gen_save: 'Guardar como rutina',
  gen_discard: 'Descartar',
  gen_regenerate: 'Generar otra',
  gen_error_budget: 'Se agotó el presupuesto de IA de este mes.',
  gen_error_offline: 'Sin conexión: el generador necesita red.',
  gen_error_other: 'No se pudo generar. Probá de nuevo.',
  gen_no_key: 'Configurá una API key en Ajustes para usar el generador.',
  routine_template_desc: 'Se crea como rutina nueva; la actual no se toca.',
  routine_template_days: '{n} días/semana',
  routine_template_use: 'Usar',
  routine_template_all: 'Ver todas',
  routine_template_filtered: 'Solo las de mi perfil',
  ...
  measure_thigh: 'Muslo',
  measure_hip: 'Cadera',
  adherence_title: 'Adherencia (4 semanas)',
  adherence_none: 'Decí cuántos días por semana entrenás para ver tu adherencia.',
  ...
  generator_tokens_used: '{n} tokens usados',
