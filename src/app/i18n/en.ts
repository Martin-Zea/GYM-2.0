...
export const en: Translations = {
  ...
  session_ctx_pr: 'Record',
  session_ctx_why: 'Why this weight',
  ...
  nav_panel: 'Dashboard',
  nav_history: 'History',
  rail_collapse: 'Collapse column',
  rail_expand: 'Expand column',
  rail_group_today: 'Today',
  rail_group_tools: 'Tools',
  rail_group_filter_day: 'Filter by day',
  rail_group_my_routines: 'My routines',
  rail_group_sections: 'Sections',
  rail_group_summary: 'Summary',
  rail_all_days: 'All sessions',
  rail_today_focus: 'Up next',
  rail_rest_day: 'Rest',
  rail_week_done: 'This week',
  rail_streak: 'Streak',
  rail_ai_month: 'Used this month',
  rail_export_now: 'Export now',
  ...
  profile_fold_empty: 'Not set',
  profile_fold_measures: '{n} logged',
  profile_fold_equipment: '{n} selected',
  profile_fold_written: 'Written',
  profile_age_years: '{n} years',
  ...
  routines_default_name: 'My routine',
  ...
  routines_edit_day: 'Edit day',
  rt_col_exercise: 'Exercise',
  ...
  generator_context_edit: 'Edit',
  generator_context_done: 'Done',
  generator_context_no_level: 'Level not set',
  generator_context_no_goal: 'No goal',
  generator_context_any_gym: 'Full gym',
  ...
  generator_layoff_note: 'Back after {n} days off: less volume will be requested at first.',
  ...
  coach_title: 'Coach',
  coach_delta_same: 'same',
  coach_cause_layoff: 'Cut back after the layoff: coming back is not continuing',
  coach_cause_injury: 'Discomfort reported on this lift: no increase',
  coach_cause_hard_feel: 'You marked the last one hard: no increase',
  coach_cause_max_increase: 'Capped at the most it can go up at once',
  coach_context_layoff: 'Layoff on record',
  coach_context_no_notes: 'No notes or injuries',
  coach_desk_proposal: "Today's proposal",
  coach_desk_eyebrow: "TODAY'S PROPOSAL",
  coach_col_exercise: 'EXERCISE',
  coach_col_last: 'LAST TIME',
  coach_col_proposal: 'PROPOSAL',
  coach_col_why: 'WHY',
  coach_desk_context: 'WHAT I KNOW ABOUT YOU',
  coach_desk_fix: 'Fix',
  coach_desk_changes: '{n} changes from your last session',
  coach_desk_note: 'Saved as today’s suggestion. You can change any weight during the session.',
  coach_desk_apply: "Apply to today's session",
  coach_desk_first_time: 'No history: the engine’s starting point',
  coach_chat_side_title: 'Talk to the coach',
  coach_chat_side_sub: 'What you tell it changes the proposal on the left',
  ...
  coach_batch_body: 'The engine proposes changes to {n} exercises in this session.',
  coach_batch_accept: 'Accept all',
  coach_batch_review: 'Review one by one',
  coach_accept: 'Accept',
  coach_change: 'Change',
  coach_reject: 'No',
  ...
  panel_eyebrow: 'Your last 7 days',
  panel_headline_up: 'You lifted {pct}% more than last week',
  panel_headline_down: 'You lifted {pct}% less than last week',
  panel_headline_idle: 'No training logged this week yet',
  panel_headline_neutral_one: '1 session so far this week',
  panel_headline_neutral: '{n} sessions so far this week',
  panel_day1_eyebrow: 'YOUR FIRST DAY',
  panel_day1_headline: 'Nothing to measure yet. Train once and this lights up.',
  panel_day1_locked: 'after your first session',
  panel_day1_groups: 'Volume by muscle group appears as soon as you log your first sets.',
  panel_day1_table: 'Your sessions will be listed here, with sets, duration and volume.',
  panel_kpi_volume: 'Volume',
  panel_kpi_sets: 'Sets',
  panel_kpi_sessions: 'Sessions',
  panel_unit_t: 't',
  panel_vs_previous: 'vs. last week',
  panel_no_comparison: 'No previous week to compare',
  panel_groups_title: 'Volume by muscle group',
  panel_groups_sub: 'Last week sets · shaded band is the recommended range',
  panel_groups_empty: 'Not enough sets yet to break down by group.',
  panel_table_title: 'Recent sessions',
  panel_col_date: 'Date',
  panel_col_day: 'Day',
  panel_col_sets: 'Sets',
  panel_col_duration: 'Duration',
  panel_col_volume: 'Volume',
  home_week_title: 'This week',
  home_week_of: 'of {n}',
  home_volume: 'Volume',
  home_adherence_week: 'last week',
  home_adherence_weeks: 'last {n} weeks',
  home_adherence: 'Adherence',
  home_next_title: 'Up next',
  home_streak: 'Streak',
  home_streak_unit: 'wk',
  ...
  progress_streak_unit: 'days',
  progress_adherence: 'Adherence',
  progress_avg_duration: 'Duration',
